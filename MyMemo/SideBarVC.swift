...
class SideBarVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.emailLabel.text = "min92mon@gmail.com"
        ...
        self.profileImage.image = UIImage(named: "account@2x.jpg")
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row == 0 {
            let uv = self.storyboard?.instantiateViewController(withIdentifier: "MemoWriteVC")
